module github.com/navzar05/descentralized-timestamp-authority
...
require (
	...
	github.com/hyperledger/fabric-gateway v1.9.0 // indirect
	...
	github.com/navzar05/timestamp-blockchain v1.0.8 // indirect
